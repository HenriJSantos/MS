...
model.addConstr(Sensor11 <= 3845, "c15")
model.addConstr(Sensor24 <= 3698, "c15")
model.addConstr(Sensor25 <= 3737, "c15")
model.addConstr(Sensor5 <= 4275, "c15")
model.addConstr(Sensor21 <= 2419, "c15")
model.addConstr(Sensor20 <= 2254, "c15")
model.addConstr(Sensor19 <= 2648, "c15")
model.addConstr(Sensor7 <= 5521, "c15")
model.addConstr(Sensor6 <= 4945, "c15")
model.addConstr(Sensor10 <= 1228, "c15")
model.addConstr(Sensor12 <= 4886, "c15")
model.addConstr(Sensor9 <= 5959, "c15")
model.addConstr(Sensor8 <= 6871, "c15")
...
model.addConstr( Y11+Z11+C11+D11+E11+F11+G11+H11+I11+T13+U13+V13+W13+X13 +Y13+Z13+C13+D13+E13+F13+G13+H13+I13+J13+T14+U14+V14+W14+X14+Y14+Z14+C14+D14+E14+F14+G14+H14+I14+J14+T15+U15+V15+W15+X15+Y15+Z15+C15+D15+E15+F15+G15+H15+I15+J15+K15+C16+D16+E16+F16+G16+H16+I16+J16+K16+L16+T16+U16+V16+W16+X16+Y16+Z16+T17+U17+V17+W17+X17 +Y17+Z17+C17+D17+E17+F17+G17+H17+I17+J17+K17+L17+M17+T18+U18+V18+W18+X18+Y18+Z18+C18+D18+E18+F18+G18+H18+I18+J18+K18+L18+M18+T19+U19+V19+W19+X19 +Y19+Z19+C19+D19+E19+F19+G19+H19+I19+J19+K19+L19+M19+N19+C20+D20+E20+F20+G20+H20+I20+J20+K20+L20+M20+N20+O20+T20+U20+V20+W20+X20 
X28+Y28 == Sensor8, "c4")

model.addConstr(U3+V3+W3+X3+Y3+Z3+U4+V4+W4+X4+Y4+Z4+C4+U5+V5+W5+X5+Y5+Z5+C5+D5+U6+V6+W6+X6+Y6+Z6+C6+D6+E6+U7+V7+W7+X7+Y7+Z7+C7+D7+E7+F7+U8+V8+W8+X8+Y8+Z8+C8+D8+E8+F8+
G8+U9+V9+W9+X9+Y9+Z9+C9+D9+E9+F9+G9+U10+V10+W10+X10+Y10+Z10+C10+D10+E10+F10+G10+H10+U11+V11+W11+X11+ Y11+Z11+C11+D11+E11+F11+G11+H11+I11+U13+V13+W13+X13 +Y13+Z13+C13+
D13+E13+F13+G13+H13+I13+J13+U14+V14+W14+X14+Y14+Z14+C14+D14+E14+F14+G14+H14+I14+J14+U15+V15+W15+X15+Y15+Z15+C15+D15+E15+F15+G15+H15+I15+J15+K15+U16+V16+W16+X16+Y16+
Z16+C16+D16+E16+F16+G16+H16+I16+J16+K16+L16+U17+V17+W17+X17 +Y17+Z17+C17+D17+E17+F17+G17+H17+I17+J17+K17+L17+M17+U18+V18+W18+X18+Y18+Z18+C18+D18+E18+F18+G18+H18+I18+
J18+K18+L18+M18+U19+V19+W19+X19 +Y19+Z19+C19+D19+E19+F19+G19+H19+I19+J19+K19+L19+M19+N19+U20+V20+W20+X20  == Sensor9, "c3")
...
with open('matrizOD_c.csv', mode='a') as solution_file:
